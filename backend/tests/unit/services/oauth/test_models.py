...
class TestUserEmail:
    ...
    def test_user_email_defaults(self):
        ...
        email = OAuthUserEmail(email="test@example.com")
    ...
    def test_email_validation(self):
        ...
        # Valid email
        valid_email = OAuthUserEmail(email="test@example.com")
        assert valid_email.email == "test@example.com"
        
        # Invalid email (missing @)
        with pytest.raises(ValidationError):
            OAuthUserEmail(email="invalid-email")
        
        # Test email is converted to lowercase
        uppercase_email = OAuthUserEmail(email="TEST@EXAMPLE.COM")
