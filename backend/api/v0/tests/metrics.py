"""
Metrics metadata endpoint for test framework.
...
from services.test.metric_config import MetricRegistry
from services.test.metric_metadata_models import MetricsMetadataResponse
...
async def get_metrics_metadata(
    ...
    - Required actual fields (from test execution)
