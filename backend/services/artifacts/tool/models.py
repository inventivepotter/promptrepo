...
class ToolMeta(BaseModel):
    """
    Tool metadata model that wraps ToolData with repository information.
    """
    tool: ToolData = Field(..., description="Complete tool data")
    repo_name: str = Field(..., description="Repository name where tool is stored")
