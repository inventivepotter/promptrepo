...
from services.test.models import MetricType, MetricConfig
...
class TestProfessionalismMetric:
    ...
    @patch('services.test.deepeval.custom_metrics.professionalism_metric.GEval.measure')
...
class TestConcisenessMetric:
    ...
    @patch('services.test.deepeval.custom_metrics.conciseness_metric.GEval.measure')
