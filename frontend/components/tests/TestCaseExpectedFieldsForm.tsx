...
import type { MetricConfig, ExpectedEvaluationFieldsModel } from '@/types/test';

interface TestCaseExpectedFieldsFormProps {
  /** Metrics configured in the parent test suite */
 ...
 * Dynamically generates forms based on metrics selected in the parent test suite.
 */
export function TestCaseExpectedFieldsForm({
  suiteMetrics,
  expectedFields,
  onExpectedFieldsChange,
}: TestCaseExpectedFieldsFormProps) {
    ...
    return (
      ...
      >
        <Text fontSize="sm" color="gray.600">
          No metrics in this test suite require expected fields.
        </Text>
    ...
    <VStack align="stretch" gap={4}>
      ...
      <Box p={3} bg="blue.50" borderRadius="md" borderLeft="4px solid" borderColor="blue.500">
        <Text fontSize="xs" color="blue.900">
          <strong>Note:</strong> These expected values will be used to evaluate this specific test case
          against the configured metrics. Make sure to provide all required fields.
        </Text>
      </Box>
    </VStack>
  );
