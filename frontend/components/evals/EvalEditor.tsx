...
import type { EvalDefinition, MetricConfig } from '@/types/eval';
import { MetricSelector } from './MetricSelector';

export interface EvalEditorProps {
  eval: EvalDefinition;
  onChange: (evalData: EvalDefinition) => void;
}

export function EvalEditor({ eval: evalData, onChange }: EvalEditorProps) {
  ...
  return (
    <VStack gap={6} align="stretch">
      {/* Eval Information Section */}
      <Card.Root>
        <Card.Body>
          <Fieldset.Root>
            <HStack justify="space-between" align="center">
              <Stack flex={1}>
                <Fieldset.Legend>Eval Information</Fieldset.Legend>
                <Fieldset.HelperText color="text.tertiary">
                  Configure the basic information and metadata for this eval
                </Fieldset.HelperText>
              </Stack>
              <Button
                variant="ghost"
                ...
                aria-label={isOpen ? "Collapse eval information" : "Expand eval information"}
              >
                <HStack gap={1}>
                  ...
                  <VStack gap={4} align="stretch" mt={3}>
                    ...
                    <Field.Root>
                      ...
                      <Textarea
                        ...
                        placeholder="Describe the purpose of this eval"
                        rows={2}
                        resize="vertical"
                      />
                    </Field.Root>
